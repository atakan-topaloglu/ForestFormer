...
model = dict(
    ...
    backbone=dict(
        ...
        # Load pretrained weights for encoder/decoder (embedding will be reinitialized)
        pretrained="/cluster/scratch/atopaloglu/forestpoint/pretrained/ptv3_scannet_base.pth",
